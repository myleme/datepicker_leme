                ...
                module = {
                    ...
                    event: {
                        ...
                        keydown: function (event) {
                            var possibleKeys = [27, 9, 37, 38, 39, 40, 13];

                            if (!possibleKeys.includes(event.keyCode) && !module.manualInsert) {
                                module.manualInsert = true;
                            }
                            ...
                            if (module.popup('is visible')) {
                                if (event.keyCode === 37 || event.keyCode === 38 || event.keyCode === 39 || event.keyCode === 40) {
                                    ...
                                    if (date && module.manualInsert) {
                                        module.selectDate(date);
                                        module.popup('hide');
                                    } else if (date && !settings.isDisabled(date, mode)) {
                                        module.selectDate(date);
                                    }
